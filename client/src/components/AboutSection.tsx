    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(28,105,212,0.06) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
        ...
        >
          ...
          <div>
            <div className="fade-up delay-200">
              ...
              >
                <strong style={{ color: "#f0f0ee" }}>MTEX PARTS</strong> е
                водеща автоморга за качествени употребявани авточасти,
                специализирана изключително в марките{" "}
                <strong style={{ color: "#60a5fa" }}>
                  BMW и Mercedes-Benz
                </strong>
                . Намираме се в{" "}
                <strong style={{ color: "#f0f0ee" }}>Варна, България</strong> и
              ...
              >
                Нашата мисия е да предоставяме{" "}
                <strong style={{ color: "#f0f0ee" }}>OEM качество</strong> на
                достъпни цени. Всяка авточаст преминава проверка преди продажба,
                за да сме сигурни, че получавате надеждна и функционираща
                компонента за вашия автомобил.
              </p>
            </div>

            {/* Values */}
            <div
              className="fade-up delay-300 about-values-grid"
              style={{
                display: "grid",
                gap: "1rem",
                marginBottom: "2.5rem",
