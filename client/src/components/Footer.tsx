      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Специализирана автоморга за качествени употребявани OEM авточасти
              за BMW и Mercedes-Benz. Намираме се в Варна, обслужваме цяла
              България.
            </p>
        ...
        >
          ...
          >
            &copy; {year} MTEX PARTS – BMW &amp; Mercedes-Benz Авточасти. Варна,
            България.
          </p>
          <div style={{ display: "flex", gap: "1.5rem" }}>
            {["Начало", "Услуги", "Наличност", "За нас", "Контакт"].map(
              (label, i) => {
                const hrefs = [
                  "#home",
                  "#services",
